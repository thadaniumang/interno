...
<?php
    ...
    $sql2 = "SELECT stud_id FROM student WHERE user_id='$user_id'";
    $result2 = mysqli_query($conn, $sql2);
    $student = mysqli_fetch_assoc($result2);
    $student_id = $student['student_id'];

    $sql3 = "SELECT * FROM applications WHERE student_id='$student_id'";
...
?>
    <section class="bg-white py-4">
        <div class="container mx-auto pt-6">
            ...
            <button class="w-full text-center py-3 rounded bg-green-500 text-white hover:bg-green-600 focus:outline-none my-1" onclick="window.location.href='internships.php'">Apply for Internships</button>
