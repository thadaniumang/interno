...
<div class="bg-grey-lighter min-h-screen flex flex-col">
    <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
        ...
        <form class="bg-white px-6 py-8 rounded shadow-md text-black w-full" action="../backend/auth/auth.php" method="POST">
            ...
            <span class="border-grey-light">Phone Number</span>
            ...
            <span class="border-grey-light">Company Name</span>
            ...
            <span class="border-grey-light">Company Website</span>
            ...
            <input type="submit" class="w-full text-center py-3 rounded bg-green-500 text-white hover:bg-green-600 focus:outline-none my-1" name="submit_recruiter" id="submit_recruiter" value="Submit">
        </form>
    </div>
</div>
