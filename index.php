...
<?php include('./templates/header.php'); ?>
    ...
    <section class="bg-white py-4">
        <div class="container mx-auto flex items-center flex-wrap pt-6">
            <div id="features" class="w-full px-6 py-1">
                <h3 class="uppercase tracking-wide font-bold text-gray-800 text-xl">Features</h3>
            </div>
    ...
    <section class="bg-white py-4">
        <div class="container px-6 mx-auto">
            <h3 class="uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl mb-4">About</h3>
